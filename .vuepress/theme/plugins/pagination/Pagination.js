    ...
    return h('div', {
      ...
      h('div', {
        ...
        h('span', {
          ...
          domProps: { innerHTML: this.paginationLocales.prev }
        }),
        h('span', {
          class: { efont: true },
        ...
        h('span', {
          ...
          domProps: { innerHTML: this.paginationLocales.next },
          on: { click: this.goNext }
        }),
        h('span', {
          class: { jumppoint: true },
          domProps: { innerHTML: this.paginationLocales.jump }
        }),
        h('span', {
          class: { jumpinp: true }
        }, [h('input', {
        ...
        h('span', {
          ...
          domProps: { innerHTML: this.paginationLocales.go }
        })
      ])
    ])
  },
